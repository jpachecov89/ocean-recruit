...
namespace Oceans.Test
{
    public class RecruitingTest
    {
        ...
        public void SubscriptionsExpiringNextYearNextMonth()
        {
            ...
            Assert.True(user.ExpiredSubscriptions == 0, $"Expected expired subscriptions: 2 - Your code returns: {user.ExpiredSubscriptions}");
        }
        ...
        public void SubscriptionsExpiredLastMonth_UsingFluentAssertions()
        {
            ...
            user.ExpiredSubscriptions.Should().Equals(2);
        }
        ...
        public void UserInformationUpdates()
        {
            ...
            var userTuple = user.UserInformation();

            Assert.True(userTuple.Item1 == "Oceans Code Experts", "User name in tuple management");
